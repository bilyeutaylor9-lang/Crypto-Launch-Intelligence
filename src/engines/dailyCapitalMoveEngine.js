...
function nextSources(missing = []) {
  const sourceMap = {
    ...
    "pool or market": ["DexScreener", "GeckoTerminal", "LI.FI keyless quote", "DEX quote adapter", "CEX public order book"],
    "executable liquidity": ["DexScreener", "GeckoTerminal", "LI.FI keyless quote", "DEX quote adapter"],
    "circulating market cap": ["CoinGecko", "CoinPaprika", "CoinLore", "supply explorer"],
    "fresh verified buy and sell route": ["LI.FI keyless quote", "chain-native DEX quote", "CEX public order book", "Jupiter (API key required)", "0x (API key required)"],
