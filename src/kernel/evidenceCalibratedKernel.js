...
export function buildEngineManifestAudit() {
  ...
  const contractAudits = contracts.map((contract) => {
    ...
    if (!contract.outputContract?.scoreFields?.length && !contract.outputContract?.nonScoringOutput) {
      warnings.push("no score fields declared");
    }
...
function kernelAuditBaseProject() {
  ...
  return {
    ...
    sourceReliability: { score: 84, sources: [{ source: "dexscreener", score: 86 }] },
    richTokenScore: 84,
    ...
    richTokenReasons: ["Fixture has verified liquidity, route identity, and buyer demand."],
    liquidityUsd: 900000,
    ...
    buyPressureScore: 80,
    buyTransactions24h: 340,
    sellTransactions24h: 190,
    uniqueBuyers24h: 260,
    sameBlockBuys: 0,
    bundledTxCount: 0,
    sniperBuyers24h: 4,
    ...
    smartWalletBuys24h: 9,
    smartWalletSells24h: 2,
    smartWalletBuyVolumeUsd: 92_000,
    smartWalletSellVolumeUsd: 14_000,
    smartWalletNetFlowUsd: 78_000,
    smartWalletBuyCount: 9,
    smartWalletSellCount: 2,
    accumulationDays: 5,
    smartWallets: [
      {
    ...
    smartWalletPerformanceLevel: "strong wallet signal",
    ...
    deployerReputationScore: 84,
    deployerRiskScore: 6,
    deployerReputationVerdict: "Constructive Deployer History",
    bundledLaunchRiskScore: 4,
    bundledLaunchScore: 84,
    bundledLaunchVerdict: "No Dominant Bundle",
    bundledLaunch: { sameBlockBuys: 0, bundledTxCount: 0, totalBuyers: 260, bundleSharePct: 1.54 },
    washTradingRiskScore: 5,
    washTradingScore: 88,
    washTradingVerdict: "No Dominant Wash Pattern",
    washTrading: { buyVolumeUsd: 124000, sellVolumeUsd: 76000, roundTripRatio: 0.613 },
    ...
    github: "https://github.com/fixture/alpha",
    repository: "fixture/alpha",
    commits30d: 78,
    contributors: 9,
    releases: 2,
    githubQualityScore: 82,
    githubProScore: 78,
    ...
    velocity: {
      volumeVelocity: 44,
      liquidityVelocity: 35,
      holderVelocity: 28,
      followerVelocity: 18,
      developerVelocity: 23,
      smartWalletVelocity: 25,
    },
    previousVolumeVelocity: 15,
    previousLiquidityVelocity: 12,
    previousHolderVelocity: 10,
    previousFollowerVelocity: 7,
    previousDeveloperVelocity: 8,
    previousSmartWalletVelocity: 6,
    acceleration: {
      volumeAcceleration: 29,
      liquidityAcceleration: 23,
      holderAcceleration: 18,
      followerAcceleration: 11,
      developerAcceleration: 15,
      smartWalletAcceleration: 19,
    },
    ...
    developerAccelerationV2Score: 80,
    developerAccelerationV2Status: "REAL_DEVELOPMENT_ACCELERATION",
    socialMentionsNow: 160,
    socialMentionsPrevious: 92,
    followersNow: 12_500,
    followersPrevious: 10_000,
    socialAccelerationScore: 44,
    socialAccelerationLevel: "emerging",
    socialAcceleration: {
      mentionDelta: 68,
      followerDelta: 2_500,
      mentionGrowthRate: 73.91,
      followerGrowthRate: 25,
    },
    quietAccumulationDetected: true,
    quietAccumulationScore: 80,
    quietAccumulation: { detected: true, score: 80, strength: "Strong" },
    preBreakoutMomentumScore: 78,
    preBreakoutMomentumStage: "BREAKOUT_STARTING",
    preBreakoutMomentum: { score: 78, stage: "BREAKOUT_STARTING" },
    informationAdvantageScore: 76,
    estimatedConsensusStage: "SMART_MONEY_EARLY",
    informationAdvantage: { score: 76, stage: "SMART_MONEY_EARLY" },
    smartWalletNoveltyScore: 78,
    ...
    preBreakoutSequenceScore: 86,
    preBreakoutTimingState: "PRE_BREAKOUT",
    timingState: "PRE_BREAKOUT",
    earlyAsymmetryResearchPriorityScore: 88,
    earlyAsymmetryResearchPriorityRawScore: 89,
    ...
    preConsensusOpportunityScore: 84,
    preConsensusBreakoutScore: 84,
    signalPersistenceScore: 76,
    antiManipulationConfidenceScore: 90,
    preConsensusBreakout: { score: 84, confidence: "High" },
    preConsensusBreakoutHunter: { score: 84, rank: 1 },
    ...
    executionProofRecovery: {
      status: "NOT_NEEDED_ALREADY_VERIFIED",
      attempted: false,
      selected: false,
    },
    ...
    firstSeenOpportunity: { firstSeenAt: quoteTimestamp, firstSeenResearchPriority: 88, firstSeenMissingEvidence: [] },
    firstSeenAt: quoteTimestamp,
    firstSeenResearchPriority: 88,
    ...
    opportunityEvidenceRecord: {
      projectKey: "base:0xfixturealpha",
