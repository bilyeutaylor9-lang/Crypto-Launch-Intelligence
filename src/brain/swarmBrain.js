...
export function buildEvidenceBrief(project = {}) {
  ...
  return {
    ...
    marketEvidence: {
      ...
      activeLiquidityTruthScore: boundedNumber(project.activeLiquidityTruthScore),
      liquidityControlRisk: boundedNumber(project.liquidityControlRisk),
    ...
    safetyEvidence: {
      ...
      instantSafetyRiskScore: boundedNumber(project.instantSafetyRiskScore),
      contractRiskScore: boundedNumber(project.contractRiskScore),
      honeypotRiskScore: boundedNumber(project.honeypotRiskScore),
      honeypotDetected: project.honeypotDetected === true ? true : project.honeypotDetected === false ? false : null,
      contractVerified: project.contractVerified === true ? true : project.contractVerified === false ? false : null,
      sourceCodeVerified: project.sourceCodeVerified === true ? true : project.sourceCodeVerified === false ? false : null,
      ownershipRenounced: project.ownershipRenounced === true ? true : project.ownershipRenounced === false ? false : null,
      ownershipStatus: boundedText(project.ownershipStatus, "Not supplied", 120),
      adminControlStatus: boundedText(project.adminControlStatus, "Not supplied", 120),
    ...
    holderAndWalletEvidence: {
      holderCount: boundedNumber(project.holderCount),
      holderConcentrationScore: boundedNumber(project.holderConcentrationScore),
      topHolderConcentrationPct: boundedNumber(project.topHolderConcentrationPct),
      bundledLaunchRiskScore: boundedNumber(project.bundledLaunchRiskScore),
      walletClusterRiskScore: boundedNumber(project.walletClusterRiskScore),
      washTradingRiskScore: boundedNumber(project.washTradingRiskScore),
      buyerRetentionScore: boundedNumber(project.buyerRetentionScore),
    },
    deployerEvidence: {
      deployerAddress: boundedText(project.deployerAddress, "Not supplied", 180),
      deployerReputationScore: boundedNumber(project.deployerReputationScore),
      deployerRiskScore: boundedNumber(project.deployerRiskScore),
    },
    developerEvidence: {
      developerActivityScore: boundedNumber(project.developerActivityScore),
      githubProScore: boundedNumber(project.githubProScore),
      githubScore: boundedNumber(project.githubScore),
    },
    executionEvidence: {
      purchaseRouteConfirmed: project.purchaseRouteConfirmed === true ? true : project.purchaseRouteConfirmed === false ? false : null,
      purchaseRouteStatus: boundedText(project.purchaseRouteStatus || project.purchaseRoute?.status, "Not supplied", 120),
      executionRouteAvailable: project.executionRouteAvailable === true ? true : project.executionRouteAvailable === false ? false : null,
      executionRouteStatus: boundedText(project.executionRouteStatus, "Not supplied", 120),
    },
    narrativeEvidence: {
    ...
    sourceProvenance: {
      ...
      sourceTruthScore: boundedNumber(project.sourceTruthScore),
      sourceReliabilityScore: boundedNumber(project.sourceReliabilityScore),
    },
    evidenceCoverage: {
