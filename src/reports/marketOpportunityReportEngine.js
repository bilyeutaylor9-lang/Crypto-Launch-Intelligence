...
function compact(project = {}, rank = 0) {
  ...
  return {
    ...
    marketOpportunityLearningConfidence: project.marketOpportunityLearningConfidence || "COLD_START",
    marketOpportunityLearningHints: (project.marketOpportunityLearningHints || []).slice(0, 5),
