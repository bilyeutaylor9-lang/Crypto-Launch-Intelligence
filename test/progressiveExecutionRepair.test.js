...
function liveExecutionOverrides() {
  ...
  return {
    tokenAddress: "0x0000000000000000000000000000000000000cea",
    address: "0x0000000000000000000000000000000000000cea",
    poolAddress: "0x0000000000000000000000000000000000000cab",
    dex: "Uniswap",
    dexName: "Uniswap",
    quoteAsset: "USDC",
    quoteTimestamp,
    ...
    proofOfAlphaExecutionTwin: {
      ...
      quote: { liquidityUsd: 240_000, estimatedSlippagePct: 0.4, timestamp: quoteTimestamp },
      safety: { blockers: [] },
    },
  };
}
