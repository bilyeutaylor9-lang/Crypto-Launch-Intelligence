...
function strongProject() {
  ...
  return {
    ...
    smartWalletBuys24h: 8,
    smartWalletSells24h: 2,
    smartWalletBuyVolumeUsd: 84_000,
    smartWalletSellVolumeUsd: 12_000,
    smartWalletNetFlowUsd: 72_000,
    smartWalletBuyCount: 8,
    ...
    smartWalletScore: 74,
    smartWalletPerformanceScore: 72,
    ...
    socialMentionsNow: 150,
    socialMentionsPrevious: 90,
    followersNow: 12_000,
    ...
    targetedEnrichmentPlan: { status: "NO_RECOVERABLE_GAPS", items: [] },
